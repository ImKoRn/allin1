...
public class RecyclerPauseOnScrollListener extends OnScrollListener{
    ...
    public RecyclerPauseOnScrollListener(ImageLoader imageLoader, boolean pauseOnScroll, boolean pauseOnFling) {
